    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-8 bg-white/5 border border-white/10 rounded-xl px-4 py-3">
          ...
          <span className="font-mono text-lg font-bold text-red-300 tracking-widest">
            {event.event_uid}
          </span>
        </div>
    ...
    >
      <div className="h-52 w-full overflow-hidden relative">
        ...
        <div className="absolute top-3 left-3">
          <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-red-500/80 text-white">
            🚫 Cancelled
          </span>
        </div>
      </div>
...
const CancelledEvents = () => {
  ...
  return (
    <div className="min-h-screen pt-28 pb-20 px-6 bg-gradient-to-br from-red-900 via-black to-orange-900 text-white">
      <div className="max-w-7xl mx-auto mb-10 text-center">
        ...
        >
          Events that have been revoked or cancelled
        </motion.p>
      </div>
